...
| `division_type` | `normal_split` (1->2 daughters) or `multi_way_split` (1->3+). No finer classification yet (no abnormality detection -- misaligned/lagging/micronucleus/bridge -- in v1). |
