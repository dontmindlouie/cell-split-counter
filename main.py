...
if __name__ == "__main__":
    ...
    parser.add_argument("--min-gpt-confidence", type=float, default=0.5, help="GPT backend only: verdicts below this self-reported confidence are downgraded to false_positive. 0.0 disables filtering. Lowered from 0.85 to 0.5 on 2026-07-16 -- scripts/eval_harness sweep against the M4 golden set showed 0.5 with higher recall (0.583 vs 0.250) and comparable-or-better precision (0.250 vs 0.231) than the old 0.85 floor; see scripts/eval_harness/README.md.")
